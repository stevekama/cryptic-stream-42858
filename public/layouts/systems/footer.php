                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.message == 'notLoggedIn'){
                            ...
                            $('#userProfileImage').html('<img src="'+base_url+'/public/dist/img/'+data.profile+'" width="50" class="img-circle" alt="User Image">');
                            $('#headerImg').html('<img src="'+base_url+'/public/dist/img/'+data.profile+'" class="user-image" alt="User Image">');
                            $('#sidebarImg').html('<img src="'+base_url+'/public/dist/img/'+data.profile+'" width="30" height="30" class="img-circle" alt="User Image">');
